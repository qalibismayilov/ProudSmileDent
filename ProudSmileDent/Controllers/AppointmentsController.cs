...
<<<<<<< HEAD
            var isExpired = appointment.Date <= DateTime.Now;
            var isRejected = appointment.Status == "Rejected";

            if (!isRejected && !isExpired && appointment.Status != "Pending")
            {
